...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { detail: @deck.detail, name: @deck.name, user_id: @deck.user_id } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { detail: @deck.detail, name: @deck.name, user_id: @deck.user_id } }
